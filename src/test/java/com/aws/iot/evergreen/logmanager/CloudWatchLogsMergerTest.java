...
import static com.aws.iot.evergreen.logmanager.CloudWatchLogsMerger.DEFAULT_LOG_GROUP_NAME;
import static com.aws.iot.evergreen.logmanager.CloudWatchLogsMerger.DEFAULT_LOG_STREAM_NAME;
...
public class CloudWatchLogsMergerTest extends EGServiceTestUtil {
    ...
    public void startup() throws ServiceLoadException {
        ...
        lenient().when(mockDeploymentService.getGroupConfigsForUserComponent(anyString())).thenReturn(Collections.singletonList("testGroup2"));
        lenient().when(mockDeploymentService.getAllGroupConfigs()).thenReturn(Collections.singletonList("testGroup1"));
    }
    ...
    public void GIVEN_one_component_one_file_less_than_max_WHEN_merge_THEN_reads_entire_file()
        ...
        componentLogFileInformation.add(ComponentLogFileInformation.builder()
                ...
                .build());
        merger = new CloudWatchLogsMerger(mockDeviceConfiguration, mockKernel);
    ...
    public void GIVEN_two_components_one_file_less_than_max_WHEN_merge_THEN_reads_and_merges_both_files()
        ...
        String logStream = calculateLogStreamName("testThing");
        String logStream2 = "/2020/02/10/testGroup2/testThing";
        assertTrue(logGroupInfo.containsKey(logStream));
