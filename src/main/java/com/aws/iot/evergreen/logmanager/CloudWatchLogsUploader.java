...
public class CloudWatchLogsUploader {
    ...
    /**
     * Gets the latest sequence token needed in PutLogEvents for the log group/log stream combination.
     *
     * @param logGroupName  The log group name.
     * @param logStreamName The log stream name.
     * @return the sequence token for the log group/log stream combination.
     */
